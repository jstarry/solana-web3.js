...
const SlotUpdateResult = superstruct.union([superstruct.type({
  ...
  type: superstruct.literal('confirmationProgress'),
  slot: superstruct.number(),
  timestamp: superstruct.number(),
  progress: superstruct.tuple([superstruct.number(), superstruct.number(), superstruct.number()])
})]);
/**
...
class Connection {
  ...
  _wsOnSlotUpdatesNotification(notification) {
    ...
    try {
      res = superstruct.create(notification, SlotUpdateNotificationResult);
    } catch (err) {
