...
function () {
  ...
  _createClass(Transaction, [{
    ...
    value: function _getSignData() {
      ...
      var signDataLayout = BufferLayout.struct([BufferLayout.blob(1, 'numRequiredSignatures'), BufferLayout.blob(1, 'numCreditOnlySignedAccounts'), BufferLayout.blob(1, 'numCreditOnlyUnsignedAccounts'), BufferLayout.blob(keyCount.length, 'keyCount'), BufferLayout.seq(publicKey('key'), keys.length, 'keys'), publicKey('recentBlockhash')]);
      var transaction = {
    ...
    value: function from(buffer) {
      ...
      for (var _i3 = 0; _i3 < signatureCount; _i3++) {
        var sigPubkeyPair = {
          ...
          publicKey: new PublicKey(accounts[_i3])
        };
      ...
      for (var _i4 = 0; _i4 < instructionCount; _i4++) {
        var instructionData = {
          keys: [],
          programId: new PublicKey(accounts[instructions[_i4].programIndex]),
          data: Buffer.from(instructions[_i4].data)
        };

        var _loop = function _loop(j) {
          var pubkey = new PublicKey(accounts[instructions[_i4].accountIndex[j]]);
        ...
        for (var j = 0; j < instructions[_i4].accountIndex.length; j++) {
          _loop(j);
        }

        var _instruction = new TransactionInstruction(instructionData);
...
var GetBalanceRpcResult = superstruct.struct({
...
var GetAccountInfoRpcResult = jsonRpcResult(AccountInfoResult);
/***
...
var ProgramAccountInfoResult = superstruct.struct(['string', AccountInfoResult]);
/***
...
var ConfirmTransactionRpcResult = jsonRpcResult('boolean');
/**
...
var GetSignatureStatusRpcResult = jsonRpcResult(superstruct.struct.union(['null', superstruct.struct.union([superstruct.struct({
  Ok: 'null'
}), superstruct.struct({
  Err: 'object'
})])]));
...
var GetRecentBlockhash = jsonRpcResult(['string', superstruct.struct({
...
function () {
  ...
  _createClass(Connection, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee2(publicKey) {
        var unsafeRes, res;
        return _regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return this._rpcRequest('getBalance', [publicKey.toBase58()]);

              case 2:
                unsafeRes = _context2.sent;
                res = GetBalanceRpcResult(unsafeRes);
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee3(publicKey) {
        ...
        return _regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return this._rpcRequest('getAccountInfo', [publicKey.toBase58()]);

              case 2:
                unsafeRes = _context3.sent;
                res = GetAccountInfoRpcResult(unsafeRes);
    ...
    value: function () {
        ...
        return _regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return this._rpcRequest('confirmTransaction', [signature]);

              case 2:
                unsafeRes = _context4.sent;
                res = ConfirmTransactionRpcResult(unsafeRes);
      ...
      function confirmTransaction(_x5) {
        ...
        return _regeneratorRuntime.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _context6.next = 2;
                return this._rpcRequest('getEpochVoteAccounts', []);
        ...
        return _regeneratorRuntime.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _context7.next = 2;
                return this._rpcRequest('getSlotLeader', []);
    ...
    value: function () {
        ...
        return _regeneratorRuntime.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                _context8.next = 2;
                return this._rpcRequest('getSignatureStatus', [signature]);
      ...
      function getSignatureStatus(_x6) {
        ...
        return _regeneratorRuntime.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                _context9.next = 2;
                return this._rpcRequest('getTransactionCount', []);
        ...
        return _regeneratorRuntime.wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                _context10.next = 2;
                return this._rpcRequest('getRecentBlockhash', []);
              ...
              case 7:
                ...
                return _context10.abrupt("return", [blockhash, feeCalculator]);
              ...
              case 15:
                // End Legacy v0.15 response
                res = GetRecentBlockhash(unsafeRes);
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee11(to, amount) {
        var unsafeRes, res;
      ...
      function requestAirdrop(_x7, _x8) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee12(transaction) {
        var _len,
            signers,
            _key,
            seconds,
        ...
        return _regeneratorRuntime.wrap(function _callee12$(_context12) {
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                for (_len = _args12.length, signers = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
                  signers[_key - 1] = _args12[_key];
                }
        ...
        return _regeneratorRuntime.wrap(function _callee13$(_context13) {
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
                _context13.next = 2;
                return this._rpcRequest('fullnodeExit', []);
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee14(rawTransaction) {
        var unsafeRes, res;
        return _regeneratorRuntime.wrap(function _callee14$(_context14) {
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
                _context14.next = 2;
                return this._rpcRequest('sendTransaction', [_toConsumableArray(rawTransaction)]);
      ...
      function sendRawTransaction(_x10) {
    ...
    value: function () {
      ...
      _regeneratorRuntime.mark(function _callee15() {
          ...
          while (1) {
            switch (_context15.prev = _context15.next) {
              case 0:
                ...
                programKeys = Object.keys(this._programAccountChangeSubscriptions).map(Number);
              ...
              case 51:
                ...
                _id2 = _step3.value;
                _this$_accountChangeS = this._accountChangeSubscriptions[_id2], subscriptionId = _this$_accountChangeS.subscriptionId, publicKey = _this$_accountChangeS.publicKey;
                ...
                _context15.prev = 55;
                _context15.next = 58;
                return this._rpcWebSocket.call('accountSubscribe', [publicKey]);

              case 58:
                this._accountChangeSubscriptions[_id2].subscriptionId = _context15.sent;
                _context15.next = 64;
                break;

              case 61:
                _context15.prev = 61;
                _context15.t2 = _context15["catch"](55);
                console.log("accountSubscribe error for ".concat(publicKey, ": ").concat(_context15.t2.message));
              ...
              case 69:
                _context15.prev = 69;
                _context15.t3 = _context15["catch"](49);
                _didIteratorError3 = true;
                _iteratorError3 = _context15.t3;
              ...
              case 86:
                ...
                _id3 = _step4.value;
                _this$_programAccount = this._programAccountChangeSubscriptions[_id3], subscriptionId = _this$_programAccount.subscriptionId, programId = _this$_programAccount.programId;
                ...
                _context15.prev = 90;
                _context15.next = 93;
                return this._rpcWebSocket.call('programSubscribe', [programId]);

              case 93:
                this._programAccountChangeSubscriptions[_id3].subscriptionId = _context15.sent;
                _context15.next = 99;
                break;

              case 96:
                _context15.prev = 96;
                _context15.t4 = _context15["catch"](90);
                console.log("programSubscribe error for ".concat(programId, ": ").concat(_context15.t4.message));
              ...
              case 104:
                _context15.prev = 104;
                _context15.t5 = _context15["catch"](84);
        ...
        }, _callee15, this, [[9, 13, 17, 25], [18,, 20, 24], [28, 32, 36, 44], [37,, 39, 43], [49, 69, 73, 81], [55, 61], [74,, 76, 80], [84, 104, 108, 116], [90, 96], [109,, 111, 115]]);
      }));
    ...
    value: function () {
          ...
          while (1) {
            switch (_context16.prev = _context16.next) {
              ...
              case 9:
                ...
                console.log('accountUnsubscribe error:', _context16.t0.message);
      ...
      function removeAccountChangeListener(_x11) {
    ...
    value: function () {
          ...
          while (1) {
            switch (_context17.prev = _context17.next) {
              case 0:
                ...
                subscriptionId = this._programAccountChangeSubscriptions[id].subscriptionId;
                ...
                _context17.prev = 4;
                _context17.next = 7;
                return this._rpcWebSocket.call('programUnsubscribe', [subscriptionId]);
              ...
              case 9:
                ...
                console.log('programUnsubscribe error:', _context17.t0.message);
      ...
      function removeProgramAccountChangeListener(_x12) {
...
function _sendAndConfirmTransaction() {
  _sendAndConfirmTransaction = _asyncToGenerator(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            start = Date.now();
            _context.next = 5;
            return connection.sendTransaction.apply(connection, [transaction].concat(signers));
...
function () {
  ...
  _createClass(SystemProgram, null, [{
    ...
    value: function createAccount(from, newAccount, lamports, space, programId) {
      var dataLayout = BufferLayout.struct([BufferLayout.u32('instruction'), BufferLayout.ns64('lamports'), BufferLayout.ns64('space'), publicKey('programId')]);
    ...
    value: function assign(from, programId) {
      var dataLayout = BufferLayout.struct([BufferLayout.u32('instruction'), publicKey('programId')]);
      var data = Buffer.alloc(dataLayout.span);
      dataLayout.encode({
        instruction: 1,
        // Assign instruction
      ...
      _regeneratorRuntime.mark(function _callee(connection, payer, program, programId, data) {
        ...
        return _regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                transaction = SystemProgram.createAccount(payer.publicKey, program.publicKey, 1, data.length, programId);
                _context.next = 3;
...
function () {
  function NativeLoader() {
    _classCallCheck(this, NativeLoader);
  }

  _createClass(NativeLoader, null, [{
    key: "load",
    ...
    value: function load(connection, payer, programName) {
      ...
      var program = new Account();
      return Loader.load(connection, payer, program, NativeLoader.programId, bytes);
    }
  }, {
    key: "programId",
...
/*#__PURE__*/
function (_BN) {
  _inherits(TokenAmount, _BN);

  function TokenAmount() {
    _classCallCheck(this, TokenAmount);

    return _possibleConstructorReturn(this, _getPrototypeOf(TokenAmount).apply(this, arguments));
  }
  ...
  _createClass(TokenAmount, [{
     ...
     */
    value: function toBuffer() {
      var a = _get(_getPrototypeOf(TokenAmount.prototype), "toArray", this).call(this).reverse();
 ...
 * @private
 */
var TokenInfoLayout = BufferLayout.struct([uint64('supply'), BufferLayout.u8('decimals'), rustString('name'), rustString('symbol')]);
/**
 ...
 * @private
 */
var TokenAccountInfoLayout = BufferLayout.struct([publicKey('token'), publicKey('owner'), uint64('amount'), BufferLayout.u8('sourceOption'), publicKey('source'), uint64('originalAmount')]);
// This type exists to workaround an esdoc parse error

/**
 * The built-in token program
 */
var SYSTEM_TOKEN_PROGRAM_ID = new PublicKey('Token11111111111111111111111111111111111111');
/**
 * An ERC20-like Token
 */
...
function () {
  ...
  function Token(connection, token) {
    var programId = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : SYSTEM_TOKEN_PROGRAM_ID;
  ...
  _createClass(Token, [{
     ...
     */
    value: function () {
      var _newAccount = _asyncToGenerator(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                transaction = SystemProgram.createAccount(owner.publicKey, tokenAccount.publicKey, 1, 1 + TokenAccountInfoLayout.span, this.programId);
                _context.next = 8;
              ...
              case 8:
                ...
                _context.next = 13;
                return sendAndConfirmTransaction(this.connection, transaction, owner, tokenAccount);

              case 13:
                return _context.abrupt("return", tokenAccount.publicKey);
    ...
    key: "tokenInfo",
    value: function () {
      var _tokenInfo = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee2() {
        var accountInfo, data, tokenInfo;
        return _regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return this.connection.getAccountInfo(this.token);
              ...
              case 2:
                ...
                throw new Error("Invalid token owner: ".concat(JSON.stringify(accountInfo.owner)));
              ...
              case 8:
                tokenInfo = TokenInfoLayout.decode(data, 1);
    ...
    key: "accountInfo",
    value: function () {
      var _accountInfo = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee3(account) {
        var accountInfo, data, tokenAccountInfo;
        return _regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return this.connection.getAccountInfo(account);
              ...
              case 8:
                tokenAccountInfo = TokenAccountInfoLayout.decode(data, 1);
      ...
      _regeneratorRuntime.mark(function _callee4(owner, source, destination, amount) {
        return _regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.t0 = sendAndConfirmTransaction;
                _context4.t1 = this.connection;
                _context4.t2 = new Transaction();
                _context4.next = 5;
                return this.transferInstruction(owner.publicKey, source, destination, amount);
        ...
        return _regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.next = 2;
                return sendAndConfirmTransaction(this.connection, new Transaction().add(this.approveInstruction(owner.publicKey, account, delegate, amount)), owner);
        ...
        return _regeneratorRuntime.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _context6.next = 2;
                return sendAndConfirmTransaction(this.connection, new Transaction().add(this.setOwnerInstruction(owner.publicKey, account, newOwner)), owner);
    ...
    key: "transferInstruction",
    value: function () {
      var _transferInstruction = _asyncToGenerator(
      /*#__PURE__*/
        ...
        return _regeneratorRuntime.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _context7.next = 2;
                return this.accountInfo(source);
              ...
              case 5:
                ...
                return _context7.abrupt("return", new TransactionInstruction({
                  keys: keys,
                  programId: this.programId,
                  data: data
                }));
      ...
      function transferInstruction(_x14, _x15, _x16, _x17) {
        return _transferInstruction.apply(this, arguments);
      }
    ...
    key: "approveInstruction",
    value: function approveInstruction(owner, account, delegate, amount) {
    ...
    key: "revokeInstruction",
    value: function revokeInstruction(owner, account, delegate) {
    ...
    key: "setOwnerInstruction",
    value: function setOwnerInstruction(owner, account, newOwner) {
      var dataLayout = BufferLayout.struct([BufferLayout.u32('instruction')]);
      var data = Buffer.alloc(dataLayout.span);
      dataLayout.encode({
      ...
      _regeneratorRuntime.mark(function _callee8(connection, owner, supply, name, symbol, decimals) {
        ...
        return _regeneratorRuntime.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                programId = _args8.length > 6 && _args8[6] !== undefined ? _args8[6] : SYSTEM_TOKEN_PROGRAM_ID;
                tokenAccount = new Account();
                token = new Token(connection, tokenAccount.publicKey, programId);
                _context8.next = 5;
                return token.newAccount(owner, null);
              ...
              case 5:
                ...
                transaction = SystemProgram.createAccount(owner.publicKey, tokenAccount.publicKey, 1, 1 + data.length, programId);
                _context8.next = 13;
              ...
              case 13:
                ...
                _context8.next = 16;
                return sendAndConfirmTransaction(connection, transaction, owner, tokenAccount);
...
function sendAndConfirmRawTransaction(_x, _x2) {
