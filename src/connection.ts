...
export type SlotUpdate = Infer<typeof SlotUpdateResult>;
...
export class Connection {
  ...
  /**
   * Register a callback to be invoked upon slot updates
   *
   ...
   * @deprecated Deprecated since v0.93.0, please use `onSignatureWithOptions`
   *
